...
export default function DashboardPage() {
  ...
  useEffect(() => { const stored = localStorage.getItem(`dozify-demo-medications-${activeProfile.dataProfileId}`); setMedications(stored ? JSON.parse(stored) : activeProfile.access === "owner" ? demoMedications : []); setTaken([]); }, [activeProfile.dataProfileId, activeProfile.access]);
